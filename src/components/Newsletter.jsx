...
function Newsletter (){
    return (
        <div className="bg-gray-900 text-white flex flex-col items-center">
            <div className="lg:flex justify-between lg:w-1/2 mx-auto items-center">
            ...
            <div>
                <form action="" className="p-4">
                    ...
                    <button className="ml-2 bg-yellow-400 h-[40px] w-[40px] cursor-pointer"><FontAwesomeIcon icon={faPaperPlane} color='white' /> </button>
                </form>
            </div>
            </div>
